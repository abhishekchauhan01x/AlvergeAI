    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#181A20] via-[#232946] to-[#181A20]">
      ...
      >
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#38BDF8] mb-2">Create Account</h2>
          <p className="text-[#A1A1AA]">Join ALVERGE AI today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#E0E7EF] mb-2">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
        ...
        <div className="text-center">
          <p className="text-[#A1A1AA]">
            ...
            <Link to="/sign-in" className="text-[#38BDF8] hover:text-[#14B8A6] transition-colors duration-200">
              Sign in
            </Link>
          </p>
        </div>
