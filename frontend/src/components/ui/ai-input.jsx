...
const AnimatedPlaceholder = ({
  ...
  <AnimatePresence mode="wait">
    <motion.p
      ...
      {showSearch ? "Search the web..." : "Ask Alverge Ai..."}
    </motion.p>
  </AnimatePresence>
)

export default function AiInput({ onSendMessage }) {
  ...
  const handleSubmit = () => {
    ...
    if (text && typeof onSendMessage === 'function') {
      onSendMessage(text, { webSearch: showSearch })
    }
    setValue("")
    adjustHeight(true)
  }
